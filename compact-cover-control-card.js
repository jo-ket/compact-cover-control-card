      ...
      <div class="room">
        <div class="room-header">
          ...
          <div class="control-buttons">
            ...
            >🌙</button>
            ${this.config.show_stop_icon?L`
              <span class="button-separator">|</span>
              <button 
                class="control-button" 
                @click=${()=>this._handleRoomStopClick(t)}
              >⏹️</button>
            `:j}
          </div>
        </div>
